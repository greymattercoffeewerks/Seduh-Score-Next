...
- **Supabase cloud project not yet linked.** Phase 0/1 only set up and verified the
  local stack. Linking a cloud project (and the `supabase db push` step CLAUDE.md's Git
  section refers to) is Phase 2+ work, once the schema is stable enough to push.
