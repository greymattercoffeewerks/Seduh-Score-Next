...
- **Grey Matter** has one person with access to the database, the owner of Seduh Score. It is used to keep the service running and to act on your requests, not to read organisers' data.
